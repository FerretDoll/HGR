...
namespace vflib
{
	...
	public:
		VF2State(ARGraph<Node1, Edge1> *g1, ARGraph<Node2, Edge2> *g2, 
	...
	template <typename Node1, typename Node2,
		...
		VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>
			::VF2State(ARGraph<Node1, Edge1> *ag1, ARGraph<Node2, Edge2> *ag2, 
			nodeID_t* order, bool induced)
	...
	template <typename Node1, typename Node2,
		...
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>
			::VF2State(const VF2State &state): State(state)
	{
		g1 = state.g1;
		g2 = state.g2;
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::~VF2State()
	{
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		bool VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::NextPair(nodeID_t *pn1, nodeID_t *pn2, nodeID_t prev_n1, nodeID_t prev_n2)
	{
	...
	template <typename Node1, typename Node2,
		...
		bool VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::IsFeasiblePair(nodeID_t node1, nodeID_t node2)
	{
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		void VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::AddPair(nodeID_t node1, nodeID_t node2)
	{
		assert(node1 < n1);
		assert(node2 < n2);
		assert(core_len < n1);
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		void VF2State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::BackTrack()
	{
