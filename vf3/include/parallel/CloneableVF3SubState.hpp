...
namespace vflib
{
	...
	public:
		...
		CloneableVF3SubState(ARGraph<Node1, Edge1> *g1, ARGraph<Node2, Edge2> *g2,
			uint32_t* class_1, uint32_t* class_2, uint32_t nclass,
			nodeID_t* order = NULL);
		CloneableVF3SubState(const CloneableVF3SubState &state,  bool hard_copy = true);
	...
	template <typename Node1, typename Node2,
		...
		CloneableVF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>
			::CloneableVF3SubState(ARGraph<Node1, Edge1> *ag1, ARGraph<Node2, Edge2> *ag2, 
	...
	template <typename Node1, typename Node2,
		...
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		CloneableVF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>
			::CloneableVF3SubState(const CloneableVF3SubState &state, bool hard_copy):State(state)
	{
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		CloneableVF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::~CloneableVF3SubState()
	{
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		void CloneableVF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::ComputeFirstGraphTraversing() {
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		bool CloneableVF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::NextPair(nodeID_t *pn1, nodeID_t *pn2, nodeID_t prev_n1, nodeID_t prev_n2)
	{
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		bool CloneableVF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::IsFeasiblePair(nodeID_t node1, nodeID_t node2)
	{
		//std::cout<<"\nIF: " <<node1<<" " << node2;
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		void CloneableVF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::AddPair(nodeID_t node1, nodeID_t node2)
	{
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		void CloneableVF3SubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::BackTrack()
	{
